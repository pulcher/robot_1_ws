...
set "AMENT_ENVIRONMENT_HOOKS[teensy_node]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[teensy_node] "%AMENT_CURRENT_PREFIX%\share\teensy_node\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[teensy_node] "%AMENT_CURRENT_PREFIX%\share\teensy_node\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[teensy_node]:;=";"%") do (
    call:call_file %%f
  )
